...
// import Navbar from "../components/Navbar";
// import Sidebar from "../components/Sidebar";
// import { Plus, Edit2, Trash2, CreditCard, Calendar, User, FileText, DollarSign, X, ChevronLeft, ChevronRight } from "lucide-react";
...
//   const totalPages = Math.ceil(paymentsData.count / PAGE_SIZE);
...
//                       className={`px-3 py-1 rounded-lg border ${!paymentsData.previous ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
//                     >
//                       <ChevronLeft size={16} />
//                     </button>
...
//                       className={`px-3 py-1 rounded-lg border ${!paymentsData.next ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
//                     >
//                       <ChevronRight size={16} />
//                     </button>
//                   </div>
